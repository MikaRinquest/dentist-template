                    ...
                    <v-list-item three line>
                      <v-list-item-content class="pa-10">
                        <v-list-item-title class="headline mb-1"
                          >Today<span class="teal--text">-25%</span>
                          discount<br />
                          on lung examinations</v-list-item-title
                        >
                        <v-list-item-subtitle
                          >The package price includes: consultation <br />
                          of a pulmonologist, spirograhpy,cardiogram
                    ...
                    <v-list-item-content class="pa-2">
                      <v-list-item-content class="pa-2">
                        <v-list-item-title class="headline"
                          >Heart Rate<br />123bpm</v-list-item-title
                        >
                      </v-list-item-content>
                      <v-list-item-avatar tile size="150" class="pr-10">
        ...
        <v-app :style="{ background: $vuetify.theme.themes.light.background }">
          <v-container>
            <v-row>
                    ...
                    <v-list two-line subheader class="ml-n8">
                      <v-list-item>
                        <v-list-item-content>
                          ...
                          <v-list-item-title>175cm</v-list-item-title>
                        </v-list-item-content>
                      </v-list-item>
                    </v-list>
                  </v-col>
                    ...
                    <v-list two-line subheader class="ml-n8">
                      <v-list-item>
                        <v-list-item-content>
                          ...
                          <v-list-item-title>64kg</v-list-item-title>
                        </v-list-item-content>
                      </v-list-item>
                    </v-list>
                  </v-col>
              ...
              <v-col cols="12" sm="12">
                <v-card
                  class="mx-12 rounded-tl-xl rounded-bl-xl rounded-br-xl mt-n4 py-4"
                  color="teal"
                  dark
                  flat
                >
                  <v-list-item three-line>
                    ...
                    <v-list-item-content class="pa-2">
                      <v-list-item-title class="head"
                        >Dentist <br />
                        <h6>8:00 - 9:00</h6>
                        <h6>Dr. Alex Brown(cab 39)</h6></v-list-item-title
                      >
                    </v-list-item-content>
                  </v-list-item>
                </v-card>
